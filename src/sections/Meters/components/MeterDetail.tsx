          ...
          <div className="bg-[var(--panel-2)] border-b border-[var(--border)] box-border caret-transparent shrink-0 px-4 py-4">
            ...
            <div className="items-center box-border caret-transparent gap-x-2 flex shrink-0 text-sm text-gray-600 mb-0">
              <div className="flex items-center gap-1">
                ...
                />
                {asset ? (
                  <a href="#assets" className="text-teal-500 hover:text-teal-400" onClick={() => setTimeout(() => window.dispatchEvent(new CustomEvent('select-asset', { detail: { id: asset.id } })), 0)}>{asset?.name}</a>
                ) : (
                  <span>Global</span>
                )}
              </div>
              ...
              <div className="flex items-center gap-1">
                <img
                  ...
                  className="text-slate-500 box-border caret-transparent shrink-0 h-4 w-4"
                />
                <a href="#locations" className="text-teal-500 hover:text-teal-400">{meter.locationName || '—'}</a>
              </div>
            </div>
          </div>
          ...
          <div className="relative box-border caret-transparent flex flex-col grow scroll-smooth overflow-auto scroll-pt-4 px-6 pt-6">
            ...
            <div className="box-border caret-transparent shrink-0 mb-4">
                        ...
                        {editingReadingId === r.id ? (
                          <div className="space-y-2 py-1">
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              <button onClick={handleUpdateReading} className="p-1 text-teal-600 hover:text-teal-700">
                                <Check size={16} />
                              </button>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex-grow">
                              <div className="flex items-center justify-between">
                                ...
                                {r.workOrderId && (
                                  <div className="text-[10px] text-teal-500 font-medium">WO: {r.workOrderId.slice(0, 8)}...</div>
                                )}
                              </div>
                            ...
                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity ml-2">
                              <button
                                ...
                                className="p-1.5 text-[var(--muted)] hover:text-teal-400 hover:bg-[rgba(47,107,255,0.1)] rounded"
                                title="Edit reading"
                              >
                                <Edit2 size={14} />
                              </button>
              ...
              <div className="flex justify-center">
                <button
                  type="button"
                  className="text-teal-500 font-medium items-center bg-transparent caret-transparent gap-x-1 flex shrink-0 h-10 justify-center tracking-[-0.2px] leading-[14px] gap-y-1 text-center text-nowrap border border-teal-500 px-4 rounded-bl rounded-br rounded-tl rounded-tr border-solid hover:text-teal-400 hover:border-teal-400"
