      ...
      <div className="box-border caret-transparent flex basis-[0%] grow p-3">
        <div className="relative text-[12.6px] box-border caret-transparent flex basis-[0%] grow leading-[15.12px]">
          <div className="box-border caret-transparent basis-[0%] grow">
            ...
            >
              Sort By:
              <div className="text-accent items-center box-border caret-transparent flex basis-[0%] grow stroke-accent">
                <span className="box-border caret-transparent block basis-[0%] grow stroke-accent text-ellipsis text-nowrap overflow-hidden ml-1">
                  <span className="font-semibold box-border caret-transparent shrink-0 stroke-accent text-nowrap">
                    Priority
                  </span>
                  : Highest First
                </span>
